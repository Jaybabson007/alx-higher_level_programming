#!/usr/bin/python3
"""This is a unittest script for the base model class"""
...
class TestBaseMethods(unittest.TestCase):
    ...
    def test_check_instance_variables(self):
        """ This test function checks instance variables """
    ...
    def test_randos_id(self):
        """This test functiont tests random arguments passed """
        test1 = Base(7)
    ...
    def test_consecutive_ids(self):
        """This test function tests consecutive ids """
        b1 = Base()
        b2 = Base()
        self.assertEqual(b1.id + 1, b2.id)

    def test_0_id(self):
        """This test function tests id to see if it duplicates """
        Base._Base__nb_objects = 0
        b1 = Base()
        b2 = Base()
        b3 = Base()
    ...
    def test_constructor(self):
        """This test function tests constructor signature """
    ...
    def test_constructor_args_2(self):
        """This test function tests constructor signature with 2 notself args """
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_to_json_string(self):
        """This test function tests to_json_string method """
    ...
    def test_from_json_string(self):
        """This test function tests from_json_string method """
    ...
    def test_load_from_file(self):
        """This test function tests load_from_file method """
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        list_in = [r1, r2]
    ...
    def test_load_from_file_empty_file(self):
        """ This test function tests the use of load_from_file with empty file """
        try:
            os.remove("Rectangle.json")
        except Exception:
            pass
