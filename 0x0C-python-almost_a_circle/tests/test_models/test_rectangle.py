#!/usr/bin/python3
"""This is a unittest script for the rectangle model class"""
...
class TestRectangleMethods(unittest.TestCase):
    """This defines tests for Rectangle class """

    @classmethod
    def setUp(self):
        """This test function runs for each test """
    ...
    def test_docstring(self):
        """This test function tests if docstring is present """
        self.assertIsNotNone(Rectangle.__doc__)

    def test_randos_id(self):
        """This test function tests random arguments passed """
        r1 = Rectangle(10, 2)
        r2 = Rectangle(2, 10)
    ...
    def test_class(self):
        """This test function tests the Rectangle class type """
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_class_inheritance(self):
        """This test function  tests if Rectangle inherits from Base """
        self.assertTrue(issubclass(Rectangle, Base))

    def test_arg_passed(self):
        """This test function tests for passing one or no argument """
        with self.assertRaises(TypeError):
            Rectangle(20)
            Rectangle()

    def test_constructor_no_args(self):
        """This test function tests constructor with no argument"""
...
and 'height'"
    ...
    def test_constructor_one_arg(self):
        """This test function tests constructor with one argument """
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_width_height_1(self):
        """This test function tests for width and height types"""
    ...
    def test_area_2(self):
        """This test function checks the return value of area method """
        r1 = Rectangle(2, 2)
    ...
    def test_area_no_args(self):
        """This test function tests area method with no arguments """
        r = Rectangle(5, 6)
        with self.assertRaises(TypeError) as e:
            Rectangle.area()
    ...
    def test_basic_display_2(self):
        """This test function tests string printed """
    ...
    def test_complex_display(self):
        """This test function tests display """
        r1 = Rectangle(2, 2)
        result = "##\n##\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            r1.display()
    ...
    def test_str(self):
        """This test function tests __str__ return value """
    ...
    def test_str_no_args(self):
        """This test function tests __str__ return value with no arguments """
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.__str__()
    ...
    def test_update_args(self):
        """This test function tests the udpate method with *args """
    ...
    def test_update_kwargs(self):
        """This test function tests the update method with **kwargs """
        r = Rectangle(1, 1, 0, 0, 1)
        self.assertEqual(str(r), "[Rectangle] (1) 0/0 - 1/1")
        r.update(height=10)
    ...
    def test_to_dictonary_1(self):
        """This test function tests to see if to_dictionary method is working"""
    ...
    def test_save_to_file_1(self):
        """This test function tests save_to_file_method with empty_file """
        Rectangle.save_to_file([])
        with open("Rectangle.json", mode="r") as myFile:
            self.assertEqual([], json.load(myFile))

    def test_save_to_file_2(self):
        """This test function tests save_to_file method with None as file """
        Rectangle.save_to_file(None)
        with open("Rectangle.json", mode="r") as myFile:
            self.assertEqual([], json.load(myFile))

    def test_save_to_file_3(self):
        """This test function tests save_to_file method """
    ...
    def test_create(self):
        """This test function tests create method """
        r1 = Rectangle(3, 5, 1)
    ...
    def test_load_from_file_1(self):
        """This test function tests load from file if file non-existent """
        r1 = Rectangle(1, 1)
        r2 = Rectangle(2, 2)
